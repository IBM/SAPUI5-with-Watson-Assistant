		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BAS-BTP demo",
									"targetURL": "#comdemoztabledemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoztabledemo-display": {
								"semanticObject": "comdemoztabledemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.ztabledemo",
									"url": sap.ui.require.toUrl("com/demo/ztabledemo")
								}
							}
						}
					}
